...
\input{tech/2-Specs.tex}

\chapter{LiDAR}
\input{tech/LiDAR/methods.tex}
\input{tech/LiDAR/results.tex}

\chapter{Computer Vision}
\input{tech/ComputerVision/introduction.tex}
\input{tech/ComputerVision/methods.tex}
\input{tech/ComputerVision/results.tex}

\chapter{Mécanique}
\input{tech/mechanical/methods.tex}

\chapter{Synthèse des résultats}
\input{tech/6-Discussion.tex}

\part{Gestion}

\chapter{Résumé}
\input{business/7-Resume.tex}

\chapter{Produits et services}
\input{business/8-Produits.tex}

\chapter{Marché et Contexte}
\input{business/9-Contexte.tex}

\chapter{Stratégie}
\input{business/10-Strategie.tex}

\chapter{Mesures}
\input{business/11-Mesures.tex}

\chapter{Finances}
\input{business/12-Finances.tex}
...
\label{app:testLiDAR}
\includepdf[pages=-, angle=90]{Docs/poiuztrewq}
